"""Settings panel for Persefoni Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__persefoni_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=persefoni_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_persefoni"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Persefoni Settings & Accounts", level=2),
